...
-in the event no matches are found for either Id searches or keyword searches the user will be notified<br> that there are no matches and promped again.<br>
...
-I learned how to:<br>
	...
	-Write SQL queries using JOIN and WHERE/LIKE conditions<br>
	-Handle SQLexceptions and MySQLNonTransientConnection issues<br>
